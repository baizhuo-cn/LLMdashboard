...
export function ComparisonChart({ models, selectedModels, type, lang }: ComparisonChartProps) {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 transition-colors">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">{t('perMillionTokens', lang)}</p>
      </div>
