...
export function BudgetPanel({ models, currency, lang }: BudgetPanelProps) {
        ...
        {result !== null && (
          <div className="mt-6 space-y-3">
            <div className="p-4 rounded-lg bg-accent/10 border border-accent/30">
              ...
              <p className="text-xl">{formatCurrency(result.daily / parseFloat(dailyCalls || '1'), currency, lang)}</p>
            </div>
